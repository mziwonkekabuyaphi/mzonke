...
(function () {
    ...
    var NAV_ITEMS = [
        { section: 'tickets',  href: 'tickets.html',       emoji: '🎫', label: 'Tickets' },
        { section: 'vvip',     href: 'vvip.html',          emoji: '👑', label: 'VVIP'    },
        { section: 'order',    href: 'order.html',         emoji: '🍔', label: 'Order'   },
        { section: 'shisha',   href: 'shisha.html',        emoji: '💨', label: 'Shisha'  },
        { section: 'vault',    href: 'lockers-vault.html', emoji: '🔒', label: 'Vault'   }
    ];
    ...
    function buildNav(container) {
        ...
        NAV_ITEMS.forEach(function (item) {
            ...
            /* Icon (emoji — no extra font dependency) */
